import argparse
import pandas as pd
from src.FaceCloseUp.Model import Model
from src.Utils.Utils import Utils

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Pre-process, Train and evaluate the Face CloseUp method')
    ...
    parser.add_argument('--N', required=False,type=int, default=7,help="Amount of sampled frames")
    ...
    if args.process_dataset:
        ...
        Model.preProcessDataset(df_annotations,args.dataset,args.N,faceDetector,landmarkExtractor,args.pre_processed,args.v)
    ...
    if args.select_frames:
        ...
        for partition,df in zip(["train","test","val"],[df_train,df_test,df_val]):
            ...
            df_frames = Model.selectFrames(df,args.dataset,args.N,faceDetector,landmarkExtractor,df_preProcessed,args.v)
    ...
    if args.learn:
        ...
        Model.train(df_train,df_val,args.lr,args.bs,args.epoch,args.N,"./faceCloseUp_weights.pth",args.v)
